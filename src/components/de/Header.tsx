...
const nav = [
  { to: `${dePaths.home}#technologie`, label: "Technologie" },
  { to: `${dePaths.home}#plaene`, label: "Pläne" },
  { to: `${dePaths.home}#wissenschaft`, label: "Wissenschaft" },
  { to: dePaths.faq, label: "FAQ", isRoute: true },
  { to: dePaths.contact, label: "Kontakt", isRoute: true },
];
    ...
    <header className="bg-white border-b border-[rgba(13,13,13,0.06)]">
      <div className="container-edge flex items-center justify-between gap-4 py-3 md:py-3.5">
        ...
        <div className="flex shrink-0 items-center gap-2 md:gap-3">
          ...
          <button aria-label="Menü öffnen" className="md:hidden p-2" onClick={() => setOpen(true)}>
      ...
      {open && (
        <div className="fixed inset-0 z-50 bg-white md:hidden">
          <div className="container-edge flex items-center justify-between py-3 pl-1">
            ...
            />
            <button aria-label="Schließen" className="p-2" onClick={() => setOpen(false)}>
              <X className="w-5 h-5" />
            </button>
          </div>
