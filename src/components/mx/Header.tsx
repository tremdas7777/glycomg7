...
const nav = [
  { to: `${mxPaths.home}#technology`, label: "Tecnología" },
  { to: `${mxPaths.home}#plans`, label: "Planes" },
  { to: `${mxPaths.home}#science`, label: "Ciencia" },
  { to: mxPaths.faq, label: "FAQ", isRoute: true },
  { to: mxPaths.contact, label: "Contacto", isRoute: true },
];
      ...
      {open && (
        <div className="fixed inset-0 z-50 bg-white md:hidden">
          <div className="container-edge flex items-center justify-between py-3 pl-1">
            ...
            />
            <button aria-label="Cerrar" className="p-2" onClick={() => setOpen(false)}>
              <X className="w-5 h-5" />
            </button>
          </div>
