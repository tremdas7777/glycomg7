...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Monitoramento contínuo de glicose em tempo real com AiDEX X CGM. Tecnologia inteligente, alertas personalizados e acompanhamento 24h direto no celular." },
