...
export const Route = createFileRoute("/politica-reembolso")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Condições de troca e reembolso dos produtos AiDEX." },
      { property: "og:title", content: "Política de Reembolso" },
      { property: "og:description", content: "Direito de arrependimento e reembolso AiDEX." },
  ...
  component: () => (
    <PolicyPage title="Política de Reembolso" intro="Garantia conforme o Código de Defesa do Consumidor.">
      ...
      <p>Entre em contato pelo email contato@contato@aidex.com.br com o número do pedido.</p>
